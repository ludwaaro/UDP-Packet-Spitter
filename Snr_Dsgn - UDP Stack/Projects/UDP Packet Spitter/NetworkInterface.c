...
portTASK_FUNCTION(EthernetTask, pParams)
{
    for( ; ; )
    {
        ...
        {
            //This functionality isn't worked into this project
...
BaseType_t xNetworkInterfaceInitialise(void)
{
    ...
    do
    {
        ...
        //xSemaphoreTake(g_hLinkUpSemaphore, portMAX_DELAY); //Aaron Commented this
    }
    ...
    InitialiseDMADescriptorLists(); //Trouble Here
...
void InitiateWOLandWait(void)
{
    ...
    // Arm the PHY and wait for an awakening (This functionality isn't worked into this project)
    //PHYPrepareWakeOnLAN();
