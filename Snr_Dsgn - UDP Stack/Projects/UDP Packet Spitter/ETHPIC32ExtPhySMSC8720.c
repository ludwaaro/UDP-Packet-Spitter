...
eEthRes EthPhyConfigureMdix(eEthOpenFlags oFlags)
{
	...
	EthMIIMReadStart(PHY_REG_SPECIAL_CTRL, ipconfigPIC32_PHY_ADDRESS);
	...
	EthMIIMWriteStart(PHY_REG_SPECIAL_CTRL, ipconfigPIC32_PHY_ADDRESS, phyReg);	
...
{
	return ipconfigPIC32_PHY_ADDRESS;
}
