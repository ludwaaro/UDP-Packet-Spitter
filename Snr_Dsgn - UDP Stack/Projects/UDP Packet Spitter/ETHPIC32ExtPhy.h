...
//Added functions to be used in a wider context than in the vending machine project
extern void					_PhyInitIo(void);
extern int					_PhyDetectReset(void);
extern unsigned short		_PhyReadReg( unsigned int rIx, unsigned int phyAdd );
